...
class LegacyDjangoSmokeTests(SimpleTestCase):
    ...
    def test_logout_action_is_last_item_in_sidebar_navigation(self):
        ...
        self.assertContains(profile_response, "<span>Uitloggen</span>")
        self.assertEqual(profile_content.count('action="/logout"'), 1)
        self.assertLess(profile_content.index("<span>Profiel</span>"), profile_content.index("<span>Uitloggen</span>"))
