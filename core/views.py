...
downloads_page = legacy_view("downloads_page")
download_catalog_file = legacy_view("download_catalog_file")
download_catalog_selection = legacy_view("download_catalog_selection")
...
amateur_clubs_teams_page = legacy_view("amateur_clubs_teams_page")
