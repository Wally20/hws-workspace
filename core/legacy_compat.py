...
ENDPOINTS = {
    ...
    "download_catalog_file": "download_catalog_file",
    "download_catalog_selection": "download_catalog_selection",
    ...
    "materialen_page": "materialen_page",
    "materialen_club_export_pdf": "materialen_club_export_pdf",
    "materialen_all_clubs_export_pdf": "materialen_all_clubs_export_pdf",
    ...
    "automatic_invoices_page": "automatic_invoices_page",
    ...
    "checklists_page": "checklists_page",
    "checklist_detail_page": "checklist_detail_page",
    "checklist_planning_detail_page": "checklist_planning_detail_page",
    "checklists_export_pdf": "checklists_export_pdf",
    "dressing_room_signs_page": "dressing_room_signs_page",
    "dressing_room_sign_detail_page": "dressing_room_sign_detail_page",
    "dressing_room_signs_export_pdf": "dressing_room_signs_export_pdf",
    "football_days_home_page": "football_days_home_page",
    ...
    "trainers_information_detail_page": "trainers_information_detail_page",
    "trainers_information_document_export_pdf": "trainers_information_document_export_pdf",
    "amateur_clubs_home_page": "amateur_clubs_home_page",
    ...
    "amateur_clubs_edit_page": "amateur_clubs_edit_page",
    "oefenstof_page": "oefenstof_page",
    "oefeningen_bibliotheek_page": "oefeningen_bibliotheek_page",
    "exercise_videos_page": "exercise_videos_page",
    "trainingen_page": "trainingen_page",
    "trainingen_saved_page": "trainingen_saved_page",
    "trainingen_maker_page": "trainingen_maker_page",
    "api_save_training": "api_save_training",
    "api_update_exercise_category": "api_update_exercise_category",
    "api_update_exercise": "api_update_exercise",
    "api_update_exercise_field_image": "api_update_exercise_field_image",
    "api_update_exercise_field_overlay": "api_update_exercise_field_overlay",
    ...
    "overeenkomsten_new_page": "overeenkomsten_new_page",
    "overeenkomsten_edit_page": "overeenkomsten_edit_page",
    "overeenkomsten_file": "overeenkomsten_file",
    "overeenkomsten_signed_file": "overeenkomsten_signed_file",
    "overeenkomsten_export_pdf": "overeenkomsten_export_pdf",
    "overeenkomsten_export_docx": "overeenkomsten_export_docx",
    "contract_public_share_page": "contract_public_share_page",
    "contract_public_pdf": "contract_public_pdf",
    ...
    "api_agenda_events": "api_agenda_events",
    "api_agenda_calendar": "api_agenda_calendar",
    ...
    "api_football_days_registration_counts": "api_football_days_registration_counts",
    "api_football_days_export_pdf": "api_football_days_export_pdf",
    "api_football_days_export_pptx": "api_football_days_export_pptx",
    ...
    "api_amateur_clubs_export_pptx": "api_amateur_clubs_export_pptx",
...
PATH_KWARGS = {
    ...
    "export_registration_team_assignment": {"product_key"},
    "materialen_club_export_pdf": {"club_id"},
    "download_catalog_file": {"file_key"},
    "checklist_detail_page": {"playbook_id"},
    "checklist_planning_detail_page": {"planning_id"},
    "dressing_room_sign_detail_page": {"document_id"},
    "dressing_room_signs_export_pdf": {"document_id"},
    "football_days_edit_page": {"playbook_id"},
    "trainers_information_detail_page": {"document_id"},
    "trainers_information_document_export_pdf": {"document_id"},
    "planning_edit_page": {"planning_id"},
    "amateur_clubs_duplicate_page": {"playbook_id"},
    "amateur_clubs_edit_page": {"playbook_id"},
    "voorstellen_maker_detail_page": {"proposal_id"},
    "overeenkomsten_edit_page": {"contract_id"},
    "overeenkomsten_file": {"contract_id"},
    "overeenkomsten_signed_file": {"contract_id"},
    "overeenkomsten_export_pdf": {"contract_id"},
    "overeenkomsten_export_docx": {"contract_id"},
    "contract_public_share_page": {"share_token"},
    "contract_public_pdf": {"share_token"},
