...
SESSION_IDLE_TIMEOUT_SECONDS = max(300, env_int("SESSION_IDLE_TIMEOUT_SECONDS", 2592000))
SESSION_ABSOLUTE_TIMEOUT_SECONDS = max(
    SESSION_IDLE_TIMEOUT_SECONDS,
    env_int("SESSION_ABSOLUTE_TIMEOUT_SECONDS", env_int("SESSION_PERSISTENT_SECONDS", 7776000)),
)
