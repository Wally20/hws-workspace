...
urlpatterns = [
    ...
    path(
        "voetbaldagen/trainers-informatie/<int:document_id>/export-pdf",
        views.trainers_information_document_export_pdf,
        name="trainers_information_document_export_pdf",
    ),
    path(
        "voetbaldagen/trainers-informatie/<int:document_id>",
        views.trainers_information_detail_page,
    ...
    path("overeenkomsten/<int:contract_id>/bestand", views.overeenkomsten_file, name="overeenkomsten_file"),
    path("overeenkomsten/<int:contract_id>/ondertekend-bestand", views.overeenkomsten_signed_file, name="overeenkomsten_signed_file"),
    ...
    path("gedeelde-overeenkomst/<str:share_token>/pdf", views.contract_public_pdf, name="contract_public_pdf"),
    path("gedeelde-overeenkomst/<str:share_token>", views.contract_public_share_page, name="contract_public_share_page"),
